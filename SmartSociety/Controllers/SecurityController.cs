...
{
    // Multiple role spellings added to avoid Access Denied issue
    [Authorize(Roles = "Security, Guard, SecurityStaff, Admin")]
    public class SecurityController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ViewBag.TodayVisitors = await _context.Visitors
                .Include(v => v.Flat)
                .Where(v => v.ValidFrom.Date <= today && v.ValidUntil.Date >= today && v.IsApproved)
        ...
        public async Task<IActionResult> VerifyPass(string gatePassCode, string actionType = "Entry")
        {
            ...
            var alreadyInside = await _context.GateLogs
                .AnyAsync(g => g.VisitorId == visitor.Id && g.Status == GateLogStatus.Entered && g.ExitTime == null);
