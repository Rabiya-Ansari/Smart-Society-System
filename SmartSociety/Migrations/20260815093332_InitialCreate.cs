        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResidentProfiles_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GatePassCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BillItems_MaintenanceBills_MaintenanceBillId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AmenityBookings_ResidentProfiles_ResidentProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmergencyContacts_ResidentProfiles_ResidentProfileId",
                        column: x => x.ResidentProfileId,
                        principalTable: "ResidentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FamilyMembers_ResidentProfiles_ResidentProfileId",
                        column: x => x.ResidentProfileId,
                        principalTable: "ResidentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecurityGuardId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GateLogs_AspNetUsers_SecurityGuardId",
                        column: x => x.SecurityGuardId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GateLogs_Visitors_VisitorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PollVotes_ResidentProfiles_ResidentProfileId",
                        column: x => x.ResidentProfileId,
                        principalTable: "ResidentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AmenityBookings_ResidentProfileId",
                table: "AmenityBookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillItems_MaintenanceBillId",
                table: "BillItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmergencyContacts_ResidentProfileId",
                table: "EmergencyContacts",
                column: "ResidentProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_FamilyMembers_ResidentProfileId",
                table: "FamilyMembers",
                column: "ResidentProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_GateLogs_SecurityGuardId",
                table: "GateLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PollVotes_PollId_ResidentProfileId",
                table: "PollVotes",
                columns: new[] { "PollId", "ResidentProfileId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PollVotes_ResidentProfileId",
                table: "PollVotes",
                column: "ResidentProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_ResidentProfiles_ApplicationUserId",
